...
@section('title', 'Edit ' . $user->name . ' | BirdHaven Admin')
...
<div class="max-w-2xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="font-headline font-extrabold text-3xl text-on-surface">Edit User</h2>
            <p class="text-on-surface-variant mt-1">Updating {{ $user->name }}</p>
        </div>
    </div>
    ...
    <div class="bg-surface-container-lowest rounded-lg shadow-sm border border-outline-variant/10 p-8">
        <form action="{{ route('admin.users.update', $user) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="flex flex-col items-center gap-4">
                ...
                <p class="text-xs text-on-surface-variant">JPG, PNG or WebP · max 1 MB · leave blank to keep current</p>
            </div>
            ...
            <div class="space-y-2">
                <label class="text-sm font-semibold text-on-surface-variant">
                    New Password <span class="text-outline font-normal">(leave blank to keep current)</span>
                </label>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div class="space-y-2">
                    ...
                    <label class="flex items-center gap-3 h-[50px] px-4 bg-surface-container rounded-DEFAULT ring-1 ring-outline-variant/20 cursor-pointer">
                        ...
                        <span class="text-sm font-medium text-on-surface" id="is_active_label">
