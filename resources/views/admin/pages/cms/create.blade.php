...
@section('title', 'New CMS Page | BirdHaven Admin')
...
<div class="max-w-3xl mx-auto">
    <div class="flex items-center gap-4 mb-8">
        ...
        <div>
            <h2 class="font-headline font-extrabold text-3xl text-on-surface">New CMS Page</h2>
            <p class="text-on-surface-variant mt-1">Create a new static content page.</p>
        </div>
    </div>
    ...
    <div class="bg-surface-container-lowest rounded-lg shadow-sm border border-outline-variant/10 p-8">
        <form action="{{ route('admin.cms.pages.store') }}" method="POST" class="space-y-6">
            ...
            <div class="space-y-2">
                ...
                <input id="page-title" name="title" type="text" value="{{ old('title') }}" placeholder="About Us"
            ...
            <div class="space-y-2">
                <label class="text-sm font-semibold text-on-surface-variant">
                    Slug
                    <span class="text-outline font-normal">(auto-generated from title)</span>
                </label>
                <input id="page-slug" name="slug" type="text" value="{{ old('slug') }}" placeholder="about-us"
            ...
            <div class="space-y-2">
                ...
                <textarea id="summernote-content" name="content">{{ old('content') }}</textarea>
            </div>

            <div class="space-y-2">
                <label class="text-sm font-semibold text-on-surface-variant">Meta Description</label>
                <input name="meta_description" type="text" value="{{ old('meta_description') }}"
            ...
            <div class="flex items-center gap-3">
                ...
                <label for="is_published" class="text-sm font-semibold text-on-surface-variant">Publish immediately</label>
            </div>
...
$(function () {
    ...
    $('#summernote-content').summernote({
        ...
        callbacks: {
            onInit: function () {
                // Remove focus outline on editor click
